# =============================================================================
# run_parallel_individual.R - Esegue un subset di scenari individual
# =============================================================================
# USO: Rscript run_parallel_individual.R <worker_id> <total_workers>
# Esempio: 4 terminali -> Rscript run_parallel_individual.R 1 4
#                         Rscript run_parallel_individual.R 2 4
#                         Rscript run_parallel_individual.R 3 4
#                         Rscript run_parallel_individual.R 4 4
# =============================================================================

args <- commandArgs(trailingOnly = TRUE)
if (length(args) < 2) {
  stop("USO: Rscript run_parallel_individual.R <worker_id> <total_workers>")
}

worker_id <- as.integer(args[1])
total_workers <- as.integer(args[2])

cat(sprintf("\n=== WORKER %d/%d - INDIVIDUAL ===\n\n", worker_id, total_workers))
...
# Directory output
dir_out <- file.path(DIR_BASE, "paper1_icc_individual")
